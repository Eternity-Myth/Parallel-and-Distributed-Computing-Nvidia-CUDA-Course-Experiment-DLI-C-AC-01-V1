...
/*
 * Refactor `initWith` to do its work in parallel
 * on a GPU.
 */
...
int main()
{
  ...
  /*
   * Launch these calls to `initWith` as kernels. Be sure to take
   * the fact that they will run asynchronously into consideration.
   */
